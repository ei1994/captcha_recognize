    ...
    with tf.Session() as sess:
        ...
        try:
          ...
          while not coord.should_stop():
            ...
            _, loss_value, test_co, train_co = sess.run([train_op, loss, test_correct, correct])
            ...
            if step % 100 == 0:
              print('>> Step %d run_train: loss = %.2f , train_correct= %d, test_correct= %d  (%.3f sec)' %
